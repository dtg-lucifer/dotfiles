...
main() {
  ...
  readonly show_directory="#[fg=$thm_pink,bg=$thm_bg,nobold,nounderscore,noitalics]$right_separator#[fg=#1e1e1e,bg=$thm_pink,nobold,nounderscore,noitalics] #[fg=$thm_fg,bg=$thm_gray] #{b:pane_current_path} #{?client_prefix,#[fg=$thm_red],#[fg=$thm_gray,bg=default]$left_separator"

  local show_window
  readonly show_window="#[fg=$thm_pink,bg=$thm_bg,nobold,nounderscore,noitalics]$right_separator#[fg=#1e1e1e,bg=$thm_pink,nobold,nounderscore,noitalics] #[fg=$thm_fg,bg=$thm_gray] #W #{?client_prefix,#[fg=$thm_red]"

  local show_session
  readonly show_session="#[fg=$thm_green]}#[bg=default]$right_separator#{?client_prefix,#[bg=$thm_red],#[bg=$thm_green]}#[fg=#1e1e1e] #[fg=$thm_fg,bg=$thm_gray] #S #[fg=$thm_gray,bg=default]$left_separator"

  local show_directory_in_window_status
  readonly show_directory_in_window_status="#[fg=#1e1e1e,bg=$thm_blue] #I #[fg=$thm_fg,bg=$thm_gray] #{b:pane_current_path} "
  ...
  readonly show_directory_in_window_status_current="#[fg=#1e1e1e,bg=$thm_gray] #I #[fg=colour255,bg=colour237] #(echo '#{pane_current_path}' | rev | cut -d'/' -f-2 | rev) "

  local show_window_in_window_status
  readonly show_window_in_window_status="#[fg=$thm_gray,bg=default]$right_separator#[fg=$thm_fg,bg=$thm_gray] #W #[fg=#1e1e1e,bg=$thm_blue] #I#[fg=$thm_blue,bg=default]$left_separator#[fg=$thm_fg,bg=default,nobold,nounderscore,noitalics] "

  local show_window_in_window_status_current
  readonly show_window_in_window_status_current="#[fg=$thm_gray,bg=default]$right_separator#[fg=$thm_fg,bg=$thm_gray] #W #[fg=#2e1e1e,bg=$thm_orange] #I#[fg=$thm_orange,bg=default]$left_separator#[fg=$thm_fg,bg=default,nobold,nounderscore,noitalics] "
